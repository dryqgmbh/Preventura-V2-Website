...
const categories = [
  {
    ...
    markers: ["ApoB", "LDL-Cholesterin", "HDL-Cholesterin", "Gesamtcholesterin", "Triglyceride", "Non-HDL-Cholesterin"],
  ...
  },
  {
    ...
    markers: ["HbA1c", "Nüchternglukose", "Insulin", "Triglycerid-Muster"],
  ...
  },
  {
    ...
    markers: ["Cystatin C", "Kreatinin", "eGFR"],
    ...
    <section id="core" className="py-24 px-6" style={{background:"#050d1a"}}>
      <div className="max-w-[1200px] mx-auto" ref={ref}>
        ...
        <div id="biomarker" className="grid lg:grid-cols-5 gap-5 observe-fade" style={{transitionDelay:"150ms"}}>
          ...
          <div key={selected.id} className="lg:col-span-3 glass rounded-3xl p-7 border flex flex-col justify-between"
            ...
            <div className="mt-8 pt-5 border-t border-white/[0.06] flex items-center justify-between">
              <p className="text-white/30 text-xs">{categories.length} Gesundheitsbereiche abgedeckt</p>
