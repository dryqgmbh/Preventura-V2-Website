...
function BiomarkerRow({ name, value, unit, status }: {
  ...
  return (
    <div className="flex items-center justify-between rounded-xl px-3 py-2.5" style={{background:"rgba(255,255,255,0.03)"}}>
      ...
      <div className="flex items-center gap-4 flex-1">
        <div className="relative shrink-0 w-[92px] h-[92px]">
          <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 92 92">
            ...
            <circle cx="46" cy="46" r={r} fill="none" stroke={`url(#${g.id}sc)`}
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <div className="flex items-center gap-1 bg-green-500/10 border border-green-500/20 rounded-lg px-2 py-1">
              ...
              <span className="text-green-400 text-[9px] font-bold">2 Optimal</span>
            </div>
          </div>
          <div className="flex items-center gap-1 bg-red-500/10 border border-red-500/20 rounded-lg px-2 py-1 w-fit">
            <span className="text-red-400 text-[9px] font-bold">3 Auffällig</span>
          </div>
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex items-center gap-2 mb-3">
        <PreventuraIcon width={16} height={16}/>
        <div className="text-white/35 text-[10px] uppercase tracking-widest">Laborergebnisse</div>
      </div>
...
function ImpactCard() {
  return (
    <div className="h-full flex flex-col">
      <div className="text-white/35 text-[10px] uppercase tracking-widest mb-1">Schwerpunkt-Maßnahmen</div>
      ...
      <div className="space-y-2 flex-1">
        {[
          ...
          <div key={item.name} className="rounded-xl px-3 py-2 border border-white/[0.04]"
            style={{background:"rgba(255,255,255,0.03)"}}>
            <div className="flex items-center justify-between mb-0.5">
              <div className="text-white font-semibold text-xs">{item.name}</div>
              <div className="w-6 h-6 rounded-full bg-green-500 flex items-center justify-center">
                <span className="text-white text-[9px] font-black">{item.delta}</span>
              </div>
            </div>
    ...
    <section id="app" className="py-24 px-6" style={{background:"#0a1628"}}>
      <div className="max-w-[1200px] mx-auto" ref={ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 observe-fade" style={{transitionDelay:"100ms"}}>
          <div className="md:col-span-5 glass rounded-3xl p-6 border border-white/[0.06] card-hover min-h-[200px]">
            <ScoreCard/>
          </div>
          <div className="md:col-span-7 glass rounded-3xl p-6 border border-white/[0.06] card-hover min-h-[200px]">
            <DashboardCard/>
          </div>
